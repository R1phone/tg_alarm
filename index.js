  ...
  try {
    ...
    if (!botToken) {
      ...
      try {
        ...
        console.error(`getMe: Error - ${e.message}, stack=${e.stack}`);
      }
    }
    ...
    try {
      ...
      console.error(`check-host: Error - ${e.message}, stack=${e.stack}`);
    }
    ...
    for (const url of webTargets) {
      try {
        ...
        console.error(`Web check (${url}): Error - ${e.message}, stack=${e.stack}`);
      }
    }
    ...
    if (willAlert && !prevAlert) {
      ...
      try {
        ...
        console.log("KV write success: alerting=true");
      } catch (e) {
    ...
    if (!willAlert && prevAlert) {
      ...
      try {
        ...
        console.log("KV write success: alerting=false");
      } catch (e) {
        console.error("KV write error:", e.message, e.stack);
      }
